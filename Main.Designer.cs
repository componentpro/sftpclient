...
namespace SftpClient
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lvwLocal = new SftpClient.DragAndDropListView();
            ...
            this.lvwRemote = new SftpClient.DragAndDropListView();
            ...
            this.SuspendLayout();
            this.client.HostKeyVerifying += new ComponentPro.Net.HostKeyVerifyingEventHandler(this.client_CheckingFingerprint);
            ...
            this.client.SetMultipleFilesAttributesCompleted += new ComponentPro.ExtendedAsyncCompletedEventHandler<ComponentPro.IO.FileSystemTransferStatistics>(this.client_SetMultipleFilesAttributesCompleted);
            this.client.MoveFilesCompleted += new ComponentPro.ExtendedAsyncCompletedEventHandler<ComponentPro.IO.FileSystemTransferStatistics>(this.client_MoveFilesCompleted);
